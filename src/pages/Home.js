    ...
    <Authenticated>
      <Container className="py-4" style={{ lineHeight: '20px' }}>
        ...
        <p className="mt-3" style={{ fontSize: '12pt' }}>
          O Vota Cidade é uma ferramenta para a população encontrar
          candidatos(as) a vereador(a) que pensam parecido com você nas eleições
          de 2020. Assim, você escolhe alguém que pensa parecido e pode cobrar
          melhor depois!
        </p>
          ...
          >
            <StyledCard>
              ...
              <CardBody>
                ...
                <CardText>
                  Nós cruzaremos as suas respostas com os candidatos e
                  candidatas cadastradas e te mostraremos quem pensa parecido
                  com você!
                </CardText>
              </CardBody>
            </StyledCard>
            ...
            <StyledCard>
              ...
              <CardBody>
                ...
                <CardText>
                  ...
                  ou candidata cadastrada para ver as respostas, comparar e
                  tomar a sua decisão.
                </CardText>
              </CardBody>
            </StyledCard>
